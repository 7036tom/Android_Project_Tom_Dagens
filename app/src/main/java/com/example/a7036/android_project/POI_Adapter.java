...
public class POI_Adapter extends Activity{

    private ImageView img1;
    private TextView Titre;
    private TextView Description;
    private String TAG_POI = POI_Adapter.class.getSimpleName();
    String id_POI;
    String url_photo;
    String nom;
    String description;
    ...
    private class GetDisplay extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(POI_Adapter.this, "Json Data is downloading", Toast.LENGTH_LONG).show();
        }
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url_POI = "http://voyage2.corellis.eu/api/v2/poi?id="+id_POI; // On veut le json du POI choisi.

            String jsonStr = sh.makeServiceCall(url_POI);

            Log.e(TAG_POI, "Response from url: " + jsonStr);
            if (jsonStr != null) {
                try {
                    ...
                    Log.e(TAG_POI, "Json parsing error: " + e.getMessage());
                ...
                Log.e(TAG_POI, "Couldn't get json from server.");
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(getApplicationContext(),
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        id_POI = getIntent().getStringExtra("id");
